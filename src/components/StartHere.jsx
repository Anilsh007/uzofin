...
export default function StartHere() {
  return (
    <section className="relative bg-black text-white flex flex-col items-center justify-center overflow-hidden pt-24 px-4 sm:px-6 lg:px-8">
      ...
      <div className="relative z-10 max-w-7xl w-full text-center backdrop-blur-md bg-black/40 p-6 sm:p-10 rounded-xl bg-no-repeat bg-left"
        style={{ backgroundImage: `url(${imgBg})`, backgroundPosition: 'left 50px top -20px', backgroundSize: 'contain', }}
      >
        ...
        <div className="mt-8 sm:mt-10 flex flex-col sm:flex-row gap-4 sm:gap-6 justify-center w-[100%] mx-auto">
